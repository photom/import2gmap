# Agent Behavior & Project Guidelines (`GEMINI.md`)

This document defines the core guidelines and operational instructions for Gemini agents working on the **import2gmap Chrome Extension** codebase.
