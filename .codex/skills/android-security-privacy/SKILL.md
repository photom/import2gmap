...
description: Security principles for Android WebViews, credential non-retention, no scraping of personal/account data, and secure inter-app data sharing via FileProvider.
---
...
### 1b. No Personal / Account Data Scraping
- Bookmark-list pages contain account UI and PII adjacent to shop lists.
- Extraction logic MUST ignore personal and account information (reviewer nickname, reviewer ID, profile image, mypage links, Tpoint, CSRF/session tokens, etc.).
- Only restaurant/shop fields required for Google Maps export may be scraped. See `web-scraping-dom-parsing`.
